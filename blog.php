        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <p class="post-category">6 October, 2023</p>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="post-meta">
                  ...
                  <?php
                  $sql = 'select post_ID, CAST(post_date AS DATE) post_date, post_title, post_image
                  from post;';
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="admin/pages/<?= $row['post_image'] ?>" alt="" class="img-fluid">
              </div>

              <p class="post-category">Hot</p>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="post-meta">
                  <p class="post-author-list">Banteay Srei</p>
                  <p class="post-date">
                    <time datetime="2022-01-01"><?= $row['post_date'] ?></time>
                  </p>
                </div>
              </div>
